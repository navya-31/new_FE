    ...
    const allow = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                await api.bookRoom(roomRequest.room_id, roomRequest.user_id, roomRequest.hotel_id)
                ...
                // dispatch(bookRoom(roomRequest.room_id, roomRequest.user_id, roomRequest.hotel_id)).then(()=>{
    ...
    return (
        <Card className={classes.card} raised elevation={6}>
            ...
            <CardActions className={classes.cardActions}>
                <Button size='small' onClick={allow} style={{color:'#3a3b7b'}} >Allow tenant</Button>
                <Button size='small' onClick={dismiss} style={{ marginTop: '30px',color:'#3a3b7b' }}>Dismiss</Button>
            </CardActions>
        </Card>
